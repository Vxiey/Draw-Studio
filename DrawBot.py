...
class DrawBotApp:
    ...
    def options(self):
        ...
        _requested_policy={
            ...
            'adaptive_detail':adaptive_detail,'quick_sketch_style':quick_sketch_style,'quick_sketch_fill_preference':quick_sketch_fill_preference,'visual_verification':visual_verification,'color_rendering':color_rendering,'color_fidelity':color_fidelity,
        ...
        adaptive_detail=_effective_policy['adaptive_detail'];quick_sketch_style=_effective_policy.get('quick_sketch_style',quick_sketch_style);quick_sketch_fill_preference=_effective_policy.get('quick_sketch_fill_preference',quick_sketch_fill_preference);visual_verification=_effective_policy['visual_verification'];color_rendering=_effective_policy['color_rendering'];color_fidelity=_effective_policy.get('color_fidelity',color_fidelity)
