...
The first updater-enabled release was `1.0.133-rc2`; `1.0.140-rc1` strengthened installed-build in-place update and automatic relaunch behavior. `1.0.143-rc3` is delivered through the same verified update chain.
