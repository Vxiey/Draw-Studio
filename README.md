...
## Download — v1.0.143-rc3

| Download | How to use it |
| --- | --- |
| [Windows installer — recommended](https://github.com/Vxiey/Draw-Studio/releases/download/v1.0.143-rc3/DrawStudio-1.0.143-rc3-Windows-x64-Setup.exe) | Run Setup, then open Draw Studio. No separate Python installation needed. |
| [Portable Windows ZIP](https://github.com/Vxiey/Draw-Studio/releases/download/v1.0.143-rc3/DrawStudio-1.0.143-rc3-Windows-x64.zip) | Extract the entire ZIP, open the DrawStudio folder and run DrawStudio.exe. Keep its supporting files together. |
| [SHA-256 checksums](https://github.com/Vxiey/Draw-Studio/releases/download/v1.0.143-rc3/DrawStudio-1.0.143-rc3-SHA256.txt) | Verify the downloaded files. |

[All releases](https://github.com/Vxiey/Draw-Studio/releases) ·
[Release notes](RELEASE-NOTES-v1.0.143-rc3.md) ·
